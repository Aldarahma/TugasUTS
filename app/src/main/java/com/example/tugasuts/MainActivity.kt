...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val inputNamaDepan = findViewById<EditText>(R.id.editFirstName)
        val inputNamaBelakang = findViewById<EditText>(R.id.editTextPassword)
        ...
        buttonSubmit.setOnClickListener {
            ...
            if (password != ulangipassword) {
                ...
                Toast.makeText(this, "Berhasil mendaftar! Selamat datang, $fullName", Toast.LENGTH_SHORT)
                    .show()
            }
        }
